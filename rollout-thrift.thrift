...
service TRolloutThriftService{
    ...
    void deactivate(1:string feature)
    void activateUser(1:string feature, 2:string userId)
    void deactivateUser(1:string feature, 2:string userId)
    void activatePercentage(1:string feature, 2:i32 percentage)
    void deactivatePercentage(1:string feature)
